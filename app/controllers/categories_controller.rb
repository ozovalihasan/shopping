class CategoriesController < ApplicationController
  ...
  def new
    ...
    render Categories::NewComponent.new(category: @category)
  end

  # GET /categories/1/edit
  def edit
    render Categories::EditComponent.new(category: @category)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @category.save
        format.html { redirect_to category_url(@category), notice: "#{@category.name} was successfully created." }
